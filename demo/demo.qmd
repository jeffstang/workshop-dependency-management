...
df <- data.frame(x = rnorm(100), y = rnorm(100) + x)
...
pd <- import("pandas")
py_df <- pd$DataFrame(dict(a = [1,2,3], b = [4,5,6]))
print(py_df)
...
- If you cannot run python chunks locally, focus on the renv portion — renv demonstrates reproducible R package management
